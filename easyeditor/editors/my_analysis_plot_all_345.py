...
def multi_plot_easy(data):
    ...
    for gen_data in data_post["generate"]:
        prompt = gen_data["prompt"]
        gen_text = gen_data["gen_text"]
        answer_list_miss = data_2["post"]["generate"][data_post["generate"].index(gen_data)]["answer_list_miss"]
        #
        insert_tok = gen_data["insert_tok"]
        correct = 0
        for answer in answer_list_miss[0:4]:
    ...
    print(correct_1 / (length))
    print(correct_2 / (length))
    print(correct_3 / (length))
    print(correct_4 / (length))
...
for tem in temporature:
    for pen in penalty:
        data_path_1 = "/home/hmpiao/hmpiao/log/melo_origin/sequential_multi_analysis_all_continue_alledits_again_3edits.json_0.02_10.0.json"
        data_path_2 = "/home/hmpiao/hmpiao/log/melo_origin/sequential_multi_analysis_all_continue_alledits_again_3edits.json_0.02_10.0.json"
        data_path_3 = "/home/hmpiao/hmpiao/log/melo_origin/sequential_multi_analysis_all_continue_alledits_again_3edits.json_0.02_10.0.json"
