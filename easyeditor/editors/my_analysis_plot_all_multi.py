...
def find_sublist_position(main_list, sub_list, prompt):
    ...
    for i, element in enumerate(main_list):
        # 检查当前元素是否为子列表的开始
        if element == sub_list[0] and sub_list == main_list[i:i+len(sub_list)]:
...
#data_path = "/data2/hmpiao/FME/log_analysis/multinormtok_test.json"
data_path = "/data2/hmpiao/FME/log_analysis/multi_analysis_all_noloss.json"
fr = open(data_path, "r")
data = json.load(fr)
...
if "port" in data_path:
    ...
    #01, 89, 2223, 2425, 4041, 7374
    for gen_data in data["generate"][0:1]:
        prompt = gen_data["prompt"]
        #gen_tok = gen_data["gen_tok"]
        gen_text = gen_data["gen_text"]
        print(gen_text)
        answer_list = gen_data["answer_list_miss"]
        ...
        if sorted_position_list[0] != 10000 and sorted_position_list[1] != 10000 and sorted_position_list[2] != 10000:
            ...
            answer_0th_prob.extend(data["origin"]["prob"][answer_list[position_before_list.index(sorted_position_before_list[0])]][str(char_tok_dict[str(sorted_position_before_list[0])]-1)][0:32])
            #print(str(char_tok_dict[str(sorted_position_before_list[0])]-1))
            #print(gen_text[sorted_position_before_list[0]:])
            answer_1th_prob.extend(data["origin"]["prob"][answer_list[position_list.index(sorted_position_list[0])]][str(char_tok_dict[str(sorted_position_before_list[1])]-1)][0:32])
            if sorted_position_list[1] != 10000:
                answer_0th_1_prob.extend(data["origin"]["prob"][answer_list[position_before_list.index(sorted_position_before_list[1])]][str(char_tok_dict[str(sorted_position_before_list[0])]-1)][0:32])
                answer_1th_2_prob.extend(data["origin"]["prob"][answer_list[position_list.index(sorted_position_list[1])]][str(char_tok_dict[str(sorted_position_before_list[1])]-1)][0:32])
            if sorted_position_list[2] != 10000:
                answer_0th_2_prob.extend(data["origin"]["prob"][answer_list[position_before_list.index(sorted_position_before_list[2])]][str(char_tok_dict[str(sorted_position_before_list[0])]-1)][0:32])
                answer_1th_3_prob.extend(data["origin"]["prob"][answer_list[position_list.index(sorted_position_list[2])]][str(char_tok_dict[str(sorted_position_before_list[1])]-1)][0:32])
        if sorted_position_list[1] != 10000 and sorted_position_list[2] != 10000 and sorted_position_list[3] != 10000:
            answer_2th_prob.extend(data["origin"]["prob"][answer_list[position_list.index(sorted_position_list[1])]][str(char_tok_dict[str(sorted_position_before_list[2])]-1)][0:32])
            if sorted_position_list[2] != 10000:    
                answer_2th_3_prob.extend(data["origin"]["prob"][answer_list[position_list.index(sorted_position_list[2])]][str(char_tok_dict[str(sorted_position_before_list[2])]-1)][0:32])
            if sorted_position_list[3] != 10000:
                answer_2th_4_prob.extend(data["origin"]["prob"][answer_list[position_list.index(sorted_position_list[3])]][str(char_tok_dict[str(sorted_position_before_list[2])]-1)][0:32])
        if sorted_position_list[2] != 10000 and sorted_position_list[3] != 10000 and sorted_position_list[4] != 10000: 
            answer_3th_prob.extend(data["origin"]["prob"][answer_list[position_list.index(sorted_position_list[2])]][str(char_tok_dict[str(sorted_position_before_list[3])]-1)][0:32])
            if sorted_position_list[3] != 10000:    
                answer_3th_4_prob.extend(data["origin"]["prob"][answer_list[position_list.index(sorted_position_list[3])]][str(char_tok_dict[str(sorted_position_before_list[3])]-1)][0:32])
            if sorted_position_list[4] != 10000:    
                answer_3th_5_prob.extend(data["origin"]["prob"][answer_list[position_list.index(sorted_position_list[4])]][str(char_tok_dict[str(sorted_position_before_list[3])]-1)][0:32])

        
        if sorted_position_list[0] != 10000 and sorted_position_list[1] != 10000 and sorted_position_list[2] != 10000:
            
            answer_0th_rank.extend(data["origin"]["rank"][answer_list[position_before_list.index(sorted_position_before_list[0])]][str(char_tok_dict[str(sorted_position_before_list[0])]-1)][0:32])
            answer_1th_rank.extend(data["origin"]["rank"][answer_list[position_list.index(sorted_position_list[0])]][str(char_tok_dict[str(sorted_position_before_list[1])]-1)][0:32])
            if sorted_position_list[1] != 10000: 
                answer_0th_1_rank.extend(data["origin"]["rank"][answer_list[position_before_list.index(sorted_position_before_list[1])]][str(char_tok_dict[str(sorted_position_before_list[0])]-1)][0:32])   
                answer_1th_2_rank.extend(data["origin"]["rank"][answer_list[position_list.index(sorted_position_list[1])]][str(char_tok_dict[str(sorted_position_before_list[1])]-1)][0:32])
            if sorted_position_list[2] != 10000:    
                answer_0th_2_rank.extend(data["origin"]["rank"][answer_list[position_before_list.index(sorted_position_before_list[2])]][str(char_tok_dict[str(sorted_position_before_list[0])]-1)][0:32])
                answer_1th_3_rank.extend(data["origin"]["rank"][answer_list[position_list.index(sorted_position_list[2])]][str(char_tok_dict[str(sorted_position_before_list[1])]-1)][0:32])
        if sorted_position_list[1] != 10000 and sorted_position_list[2] != 10000 and sorted_position_list[3] != 10000:
            answer_2th_rank.extend(data["origin"]["rank"][answer_list[position_list.index(sorted_position_list[1])]][str(char_tok_dict[str(sorted_position_before_list[2])]-1)][0:32])
            if sorted_position_list[2] != 10000: 
                answer_2th_3_rank.extend(data["origin"]["rank"][answer_list[position_list.index(sorted_position_list[2])]][str(char_tok_dict[str(sorted_position_before_list[2])]-1)][0:32])
            if sorted_position_list[3] != 10000:
                answer_2th_4_rank.extend(data["origin"]["rank"][answer_list[position_list.index(sorted_position_list[3])]][str(char_tok_dict[str(sorted_position_before_list[2])]-1)][0:32])
        if sorted_position_list[2] != 10000 and sorted_position_list[3] != 10000 and sorted_position_list[4] != 10000: 
            answer_3th_rank.extend(data["origin"]["rank"][answer_list[position_list.index(sorted_position_list[2])]][str(char_tok_dict[str(sorted_position_before_list[3])]-1)][0:32])
            if sorted_position_list[3] != 10000: 
                answer_3th_4_rank.extend(data["origin"]["rank"][answer_list[position_list.index(sorted_position_list[3])]][str(char_tok_dict[str(sorted_position_before_list[3])]-1)][0:32])
            if sorted_position_list[4] != 10000: 
                answer_3th_5_rank.extend(data["origin"]["rank"][answer_list[position_list.index(sorted_position_list[4])]][str(char_tok_dict[str(sorted_position_before_list[3])]-1)][0:32])
        '''
        ...
        if sorted_position_list[0] != 10000 and sorted_position_list[1] != 10000 and sorted_position_list[2] != 10000:
            ...
            #print(str(char_tok_dict[str(sorted_position_before_list[0])]-1))
            #print(gen_text[sorted_position_before_list[0]:])
            answer_1th_prob.extend(data["origin"]["prob"][answer_list[position_list.index(sorted_position_list[0])]][str(char_tok_dict[str(sorted_position_list[0])])][0:32])
            if sorted_position_list[1] != 10000:
                answer_0th_1_prob.extend(data["origin"]["prob"][answer_list[position_before_list.index(sorted_position_before_list[1])]][str(char_tok_dict[str(sorted_position_before_list[0])]-1)][0:32])
                answer_1th_2_prob.extend(data["origin"]["prob"][answer_list[position_list.index(sorted_position_list[1])]][str(char_tok_dict[str(sorted_position_list[0])])][0:32])
            if sorted_position_list[2] != 10000:
                answer_0th_2_prob.extend(data["origin"]["prob"][answer_list[position_before_list.index(sorted_position_before_list[2])]][str(char_tok_dict[str(sorted_position_before_list[0])]-1)][0:32])
                answer_1th_3_prob.extend(data["origin"]["prob"][answer_list[position_list.index(sorted_position_list[2])]][str(char_tok_dict[str(sorted_position_list[0])])][0:32])
        if sorted_position_list[1] != 10000 and sorted_position_list[2] != 10000:# and sorted_position_list[3] != 10000:
            answer_2th_prob.extend(data["origin"]["prob"][answer_list[position_list.index(sorted_position_list[1])]][str(char_tok_dict[str(sorted_position_list[1])])][0:32])
            if sorted_position_list[2] != 10000:    
                answer_2th_3_prob.extend(data["origin"]["prob"][answer_list[position_list.index(sorted_position_list[2])]][str(char_tok_dict[str(sorted_position_list[1])])][0:32])
            #if sorted_position_list[3] != 10000:
                #answer_2th_4_prob.extend(data["origin"]["prob"][answer_list[position_list.index(sorted_position_list[3])]][str(char_tok_dict[str(sorted_position_list[1])])][0:32])
        if sorted_position_list[2] != 10000:# and sorted_position_list[3] != 10000 and sorted_position_list[4] != 10000: 
            answer_3th_prob.extend(data["origin"]["prob"][answer_list[position_list.index(sorted_position_list[2])]][str(char_tok_dict[str(sorted_position_list[2])])][0:32])
            #if sorted_position_list[3] != 10000:    
                #answer_3th_4_prob.extend(data["origin"]["prob"][answer_list[position_list.index(sorted_position_list[3])]][str(char_tok_dict[str(sorted_position_list[2])])][0:32])
            #if sorted_position_list[4] != 10000:    
                #answer_3th_5_prob.extend(data["origin"]["prob"][answer_list[position_list.index(sorted_position_list[4])]][str(char_tok_dict[str(sorted_position_list[2])])][0:32])

        
        if sorted_position_list[0] != 10000 and sorted_position_list[1] != 10000 and sorted_position_list[2] != 10000:
            
            answer_0th_rank.extend(data["origin"]["rank"][answer_list[position_before_list.index(sorted_position_before_list[0])]][str(char_tok_dict[str(sorted_position_before_list[0])]-1)][0:32])
            answer_1th_rank.extend(data["origin"]["rank"][answer_list[position_list.index(sorted_position_list[0])]][str(char_tok_dict[str(sorted_position_list[0])])][0:32])
            if sorted_position_list[1] != 10000: 
                answer_0th_1_rank.extend(data["origin"]["rank"][answer_list[position_before_list.index(sorted_position_before_list[1])]][str(char_tok_dict[str(sorted_position_before_list[0])]-1)][0:32])   
                answer_1th_2_rank.extend(data["origin"]["rank"][answer_list[position_list.index(sorted_position_list[1])]][str(char_tok_dict[str(sorted_position_list[0])])][0:32])
            if sorted_position_list[2] != 10000:    
                answer_0th_2_rank.extend(data["origin"]["rank"][answer_list[position_before_list.index(sorted_position_before_list[2])]][str(char_tok_dict[str(sorted_position_before_list[0])]-1)][0:32])
                answer_1th_3_rank.extend(data["origin"]["rank"][answer_list[position_list.index(sorted_position_list[2])]][str(char_tok_dict[str(sorted_position_list[0])])][0:32])
        if sorted_position_list[1] != 10000 and sorted_position_list[2] != 10000:# and sorted_position_list[3] != 10000:
            answer_2th_rank.extend(data["origin"]["rank"][answer_list[position_list.index(sorted_position_list[1])]][str(char_tok_dict[str(sorted_position_list[1])])][0:32])
            if sorted_position_list[2] != 10000: 
                answer_2th_3_rank.extend(data["origin"]["rank"][answer_list[position_list.index(sorted_position_list[2])]][str(char_tok_dict[str(sorted_position_list[1])])][0:32])
            #if sorted_position_list[3] != 10000:
                #answer_2th_4_rank.extend(data["origin"]["rank"][answer_list[position_list.index(sorted_position_list[3])]][str(char_tok_dict[str(sorted_position_list[1])])][0:32])
        if sorted_position_list[2] != 10000:# and sorted_position_list[3] != 10000 and sorted_position_list[4] != 10000: 
            answer_3th_rank.extend(data["origin"]["rank"][answer_list[position_list.index(sorted_position_list[2])]][str(char_tok_dict[str(sorted_position_list[2])])][0:32])
            #if sorted_position_list[3] != 10000: 
                #answer_3th_4_rank.extend(data["origin"]["rank"][answer_list[position_list.index(sorted_position_list[3])]][str(char_tok_dict[str(sorted_position_list[2])])][0:32])
            #if sorted_position_list[4] != 10000: 
                #answer_3th_5_rank.extend(data["origin"]["rank"][answer_list[position_list.index(sorted_position_list[4])]][str(char_tok_dict[str(sorted_position_list[2])])][0:32])
    ...
    plot(list(range(31)), [answer_0th_prob_result[0:31]], title="answer_0th_prob_result", save_path="/data2/hmpiao/FME/stability_analysis/multinormpretok_answer_0th_prob_result.png")
    plot(list(range(31)), [answer_0th_1_prob_result[0:31]], title="answer_0th_1_prob_result", save_path="/data2/hmpiao/FME/stability_analysis/multinormpretok_answer_0th_1_prob_result.png")
    plot(list(range(31)), [answer_0th_2_prob_result[0:31]], title="answer_0th_2_prob_result", save_path="/data2/hmpiao/FME/stability_analysis/multinormpretok_answer_0th_2_prob_result.png")
    plot(list(range(31)), [answer_1th_prob_result[0:31]], title="answer_1th_prob_result", save_path="/data2/hmpiao/FME/stability_analysis/multinormpretok_answer_1th_prob_result.png")
    plot(list(range(31)), [answer_1th_2_prob_result[0:31]], title="answer_1th_2_prob_result", save_path="/data2/hmpiao/FME/stability_analysis/multinormpretok_answer_1th_2_prob_result.png")
    plot(list(range(31)), [answer_1th_3_prob_result[0:31]], title="answer_1th_3_prob_result", save_path="/data2/hmpiao/FME/stability_analysis/multinormpretok_answer_1th_3_prob_result.png")
    
    plot(list(range(31)), [answer_2th_prob_result[0:31]], title="answer_2th_prob_result", save_path="/data2/hmpiao/FME/stability_analysis/multinormpretok_answer_2th_prob_result.png")
    plot(list(range(31)), [answer_2th_3_prob_result[0:31]], title="answer_2th_3_prob_result", save_path="/data2/hmpiao/FME/stability_analysis/multinormpretok_answer_2th_3_prob_result.png")
    #plot(list(range(31)), [answer_2th_4_prob_result[0:31]], title="answer_2th_4_prob_result", save_path="/data2/hmpiao/FME/stability_analysis/multinormpretok_answer_2th_4_prob_result.png")
    plot(list(range(31)), [answer_3th_prob_result[0:31]], title="answer_3th_prob_result", save_path="/data2/hmpiao/FME/stability_analysis/multinormpretok_answer_3th_prob_result.png")
    #plot(list(range(31)), [answer_3th_4_prob_result[0:31]], title="answer_3th_4_prob_result", save_path="/data2/hmpiao/FME/stability_analysis/multinormpretok_answer_3th_4_prob_result.png")
    #plot(list(range(31)), [answer_3th_5_prob_result[0:31]], title="answer_3th_5_prob_result", save_path="/data2/hmpiao/FME/stability_analysis/multinormpretok_answer_3th_5_prob_result.png")
    
    
    plot(list(range(31)), [answer_0th_rank_result[0:31]], title="answer_0th_rank_result", save_path="/data2/hmpiao/FME/stability_analysis/multinormpretok_answer_0th_rank_result.png")
    plot(list(range(31)), [answer_0th_1_rank_result[0:31]], title="answer_0th_1_rank_result", save_path="/data2/hmpiao/FME/stability_analysis/multinormpretok_answer_0th_1_rank_result.png")
    plot(list(range(31)), [answer_0th_2_rank_result[0:31]], title="answer_0th_2_rank_result", save_path="/data2/hmpiao/FME/stability_analysis/multinormpretok_answer_0th_2_rank_result.png")
    plot(list(range(31)), [answer_1th_rank_result[0:31]], title="answer_1th_rank_result", save_path="/data2/hmpiao/FME/stability_analysis/multinormpretok_answer_1th_rank_result.png")
    plot(list(range(31)), [answer_1th_2_rank_result[0:31]], title="answer_1th_2_rank_result", save_path="/data2/hmpiao/FME/stability_analysis/multinormpretok_answer_1th_2_rank_result.png")
    plot(list(range(31)), [answer_1th_3_rank_result[0:31]], title="answer_1th_3_rank_result", save_path="/data2/hmpiao/FME/stability_analysis/multinormpretok_answer_1th_3_rank_result.png")
    
    plot(list(range(31)), [answer_2th_rank_result[0:31]], title="answer_2th_rank_result", save_path="/data2/hmpiao/FME/stability_analysis/multinormpretok_answer_2th_rank_result.png")
    plot(list(range(31)), [answer_2th_3_rank_result[0:31]], title="answer_2th_3_rank_result", save_path="/data2/hmpiao/FME/stability_analysis/multinormpretok_answer_2th_3_rank_result.png")
    #plot(list(range(31)), [answer_2th_4_rank_result[0:31]], title="answer_2th_4_rank_result", save_path="/data2/hmpiao/FME/stability_analysis/multinormpretok_answer_2th_4_rank_result.png")
    plot(list(range(31)), [answer_3th_rank_result[0:31]], title="answer_3th_rank_result", save_path="/data2/hmpiao/FME/stability_analysis/multinormpretok_answer_3th_rank_result.png")
    #plot(list(range(31)), [answer_3th_4_rank_result[0:31]], title="answer_3th_4_rank_result", save_path="/data2/hmpiao/FME/stability_analysis/multinormpretok_answer_3th_4_rank_result.png")
    #plot(list(range(31)), [answer_3th_5_rank_result[0:31]], title="answer_3th_5_rank_result", save_path="/data2/hmpiao/FME/stability_analysis/multinormpretok_answer_3th_5_rank_result.png")
