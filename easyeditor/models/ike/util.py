...
def encode_ike_facts(sentence_model, ds: Dataset, hparams: IKEHyperParams):
...
def encode_ike_facts_multimodal(sentence_model, ds: Dataset, hparams: IKEMultimodalHyperParams):
