...
PEFT_TYPE_TO_MODEL_MAPPING = {
    ...
    PeftType.TPATCHER: TpatcherModel,
}
...
class PeftModel(PushToHubMixin, torch.nn.Module):
    ...
    **Attributes**:
    ...
    def __init__(self, model, peft_config: PeftConfig, adapter_name="default", memory=None):
        super().__init__()
        ...
        if not isinstance(peft_config, PromptLearningConfig):
            ...
            self.base_model = PEFT_TYPE_TO_MODEL_MAPPING[peft_config.peft_type](
                self.base_model, self.peft_config, adapter_name, memory
            )
...
class PeftModelForCausalLM(PeftModel):
    ...
    def __init__(self, model, peft_config: PeftConfig, adapter_name="default", memory=None):
        super().__init__(model, peft_config, adapter_name, memory)
        #print("cnmcncnm")
