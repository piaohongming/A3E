            ...
            data.append(
                {
                    ...
                    "rephrase_prompt": record["rephrase_prompt"] if "rephrase_prompt" in record else None,
                    ...
                    "locality_rs": record["locality"]["Relation_Specificity"] if "locality" in record and "Relation_Specificity" in record["locality"] else None,
