...
def train_MEND_Blip2OPT_Caption(debug=False):
    ...
    if debug:
        train_ds = CaptionDataset('/home/hpiao6/scratch/FME/data/editing-data/caption/caption_train_edit.json', config=hparams, size=20)
        eval_ds = CaptionDataset('/home/hpiao6/scratch/FME/data/editing-data/caption/caption_eval_edit.json', config=hparams, size=20)
    else:
        train_ds = CaptionDataset('/home/hpiao6/scratch/FME/data/editing-data/caption/caption_train_edit.json', config=hparams)
        eval_ds = CaptionDataset('/home/hpiao6/scratch/FME/data/editing-data/caption/caption_eval_edit.json', config=hparams)
    print("hhhhhhh")
    trainer = MultimodalTrainer(
        config=hparams,
        train_set=train_ds,
